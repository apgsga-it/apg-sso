...
public class DbConnectionCHEI211Test {
    private static final Logger log = Logger.getLogger(DbConnectionCHEI211Test.class);
    ...
    public void testSuccessfulLogin() throws SQLException {
        ...
        datasource.setURL("jdbc:oracle:thin:@chei211.apgsga.ch:1521:chei211");
