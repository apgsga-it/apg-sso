...
class OracleUserRepositoryCHEI211Test {
    private OracleUserRepository oracleUserRepository;

    @BeforeEach
    void setUp() throws SQLException {
        MultivaluedHashMap<String, String> config = new MultivaluedHashMap<>();
        config.putSingle(OracleUserStorageProviderConstants.CONFIG_PROPERTY_DB_URL, "jdbc:oracle:thin:@chei211.apgsga.ch:1521:chei211");
